 ...
 */
function makeSync(fn, asyncArity) {

  // If the function has a length that is one less than the original
  // arity, this is a sync function. We will create a new async
  // function and call the sync function behind the scenes.
  if (fn.length === asyncArity - 1) {
